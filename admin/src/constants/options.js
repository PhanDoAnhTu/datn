...
export const CATEGORY_SECTION_OPTIONS = [
...
export const ADDITIONAL_OPTIONS = [
  ...
  { value: "date-added", label: "Ngày tạo" },
  { value: "date-modified", label: "Ngày chỉnh sửa" },
];
...
export const SELECT_OPTIONS = [
  { value: "ascending", label: "Tăng dần (A-Z)" },
  { value: "descending", label: "Giảm dần (Z-A)" },
];
