...
const DiscountAdd = ({ item }) => {
  ...
  const handlePublish = async (data) => {
    ...
    let discountInputData = {
      ...
      discount_start_date: `${data.discount_start_date.$y}-${data.discount_start_date.$M + 1}-${data.discount_start_date.$D} 00:00:00`,
      discount_end_date: `${data.discount_end_date.$y}-${data.discount_end_date.$M + 1}-${data.discount_end_date.$D} 00:00:00`,
