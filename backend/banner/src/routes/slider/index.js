...
router.post(
  "/getAllSliderByActive",
  asynchandler(SliderController.getAllSliderByActive)
);
router.post("/changeActive", asynchandler(SliderController.changeActive));
router.post("/updateOneSlider", asynchandler(SliderController.updateOneSlider));
router.post("/getOneSlider", asynchandler(SliderController.getOneSlider));
