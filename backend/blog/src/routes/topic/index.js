...
router.post("/updateOneTopic", asynchandler(topicController.updateOneTopic));
router.post("/getOneTopic", asynchandler(topicController.getOneTopic));
router.post(
  "/getListTopicByParentId",
  asynchandler(topicController.getListTopicByParentId)
);
router.post(
  "/changeIsPublished",
  asynchandler(topicController.changeIsPublished)
);
