...
export const getAddressByCustomerId = (data) => async (dispatch) => {
    try {
        const response = await PostData(
            '/user/v1/address/getAddressByCustomerId',
            data
        );
        return dispatch({ type: Action.GET_ADDRESS, payload: response.data });
    } catch (err) {
...
export const isDefaultAddress = (data) => async (dispatch) => {
    try {
        const response = await PostData(
            '/user/v1/address/isDefaultAddress',
            data
        );
        return dispatch({ type: Action.GET_ADDRESS, payload: response.data });
    } catch (err) {
...
export const findOneAddressByCustomerIdAndIsDefault =
    (data) => async (dispatch) => {
        try {
            const response = await PostData(
                '/user/v1/address/findOneAddressByCustomerIdAndIsDefault',
                data
            );
            return dispatch({
                type: Action.ADDRESS_DEFAULT,
                payload: response.data,
            });
        } catch (err) {
            console.log(err);
...
export const updateInfomation = (data) => async (dispatch) => {
    try {
        const response = await PostData(
            '/user/v1/customer/updateInfomation',
            data
        );
...
export const resetPassword = (data) => async (dispatch) => {
    try {
        const response = await PostData(
            '/user/v1/customer/resetPassword',
            data
        );
...
export const checkPassword = (data) => async (dispatch) => {
    try {
        const response = await PostData(
            '/user/v1/customer/checkPassword',
            data
        );
...
export const onChangePassword = (data) => async (dispatch) => {
    try {
        const response = await PostData(
            '/user/v1/customer/changePassword',
            data
        );
